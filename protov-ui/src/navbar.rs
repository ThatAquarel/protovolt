...
use protov_core::model::{ConfirmState, FunctionButton, Limits, PowerType};
use u8g2_fonts::types::{FontColor, HorizontalAlignment, VerticalPosition};

use crate::{
    fonts::Fonts,
    theme::{self, icons_2x, navbar_layout},
};
        ...
        D: DrawTarget<Color = Rgb565>,
    {
        ...
        fonts
            ...
            .render_aligned(
                ...
                FontColor::Transparent(theme::NAVBAR_TEXT),
                target,
            )
            .map_err(|_| ())?;
